...
export function toWorkspaceView(state) {
  return {
    ...
    keywordAssignmentRuns: state.keywordAssignmentRuns,
    keywordAssignments: state.keywordAssignments,
    unusedKeywordPool: state.unusedKeywordPool,
    pageRepairPackages: state.pageRepairPackages,
    unusedKeywordClusterRuns: state.unusedKeywordClusterRuns,
    contentOpportunities: state.contentOpportunities,
    contentHandoffs: state.contentHandoffs,
    qaRuns: state.qaRuns,
